...
with tab3:
    ...
    if option=="Manual Input":
        ...
        if file:
            ...
            st.dataframe(new_df.head(50))  # show only 50 rows to keep UI fast
            st.download_button("📥 Download all predictions", new_df.to_csv(index=False), "predictions.csv", "text/csv")
